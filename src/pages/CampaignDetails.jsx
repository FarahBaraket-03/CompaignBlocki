...
const CampaignDetails = () => {
  ...
  const getCampaignStatus = () => {
    if (!campaign || !campaign.isActive) return 'cancelled';
  ...
  const canUpdateDeadline = isOwner && getCampaignStatus() === 'active';
  const canCancelCampaign = isOwner && getCampaignStatus() === 'active';
            ...
            <div className="bg-[#2c2f32] rounded-[20px] p-6 border-2 border-[#3a3a43] sticky top-8">
              ...
              <div className="space-y-4">
                ...
                <CustomButton 
                  ...
                  disabled={!address || isLoading || getCampaignStatus() !== 'active'}
                />
                ...
                {getCampaignStatus() !== 'active' && (
                  <div className="p-3 bg-yellow-500/20 border border-yellow-500/30 rounded-[10px] text-center">
                    <p className="font-epilogue font-semibold text-[14px] text-yellow-400">
                      {getCampaignStatus() === 'cancelled' ? 'Campagne annulée' : 
                       getCampaignStatus() === 'success' ? 'Objectif atteint' : 
                       'Campagne terminée'}
                    </p>
                  </div>
                )}
